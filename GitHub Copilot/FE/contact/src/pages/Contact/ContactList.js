...
const { getAllContacts } = ContactMgr;
...
const TABLE_HEAD = [
  ...
  { id: 'contact_number', label: 'Contact No.', alignRight: false },
  { label: '', alignRight: false },
];

// import contactmgr functionalities
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Box>
            ...
            <Button
              ...
              sx={{ marginLeft: 2 }}
              onClick={() => {
                navigate('/contact-create', { replace: true });
              }}
            >
              New User
            </Button>
